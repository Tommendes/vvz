...
exports.up = function (knex) {
    return knex.schema.createTable(`${defaultApiSchema}.ftp_control`, table => {
        table.engine('InnoDB')
        ...
        table.integer('schema_id').unsigned().references('id').inTable('schemas_control').onUpdate('Cascade').onDelete('NO ACTION').comment('Schema do cliente')
...
exports.down = function (knex) {
    return knex.schema.dropTable(`${defaultApiSchema}.ftp_control`)
};

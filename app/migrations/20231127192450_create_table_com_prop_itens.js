...
exports.up = function (knex) {
    return knex.schema.createTable('vivazul_cso_root.com_prop_itens', table => {
        table.engine('InnoDB')
        ...
        table.double('quantidade', 11,2).defaultTo(0.00).comment('Quantidade')
        table.double('valor_unitario', 11,2).defaultTo(0.00).comment('Valor unitário')
...
exports.down = function (knex) {
    return knex.schema.dropTable('vivazul_cso_root.com_prop_itens')
};

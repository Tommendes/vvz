...
exports.up = function (knex) {
    return knex.schema.createTable(migrationClientSchema + '.com_prop_itens', table => {
        table.engine('InnoDB')
        ...
        table.integer('id_com_propostas').notNull().unsigned().references('id').inTable(migrationClientSchema + '.com_propostas').onUpdate('Cascade').onDelete('NO ACTION').comment('Chave estrangeira com a tabela com_propostas')
        table.integer('id_com_prop_compos').unsigned().references('id').inTable(migrationClientSchema + '.com_prop_compos').onUpdate('Cascade').onDelete('NO ACTION').comment('Chave estrangeira com a tabela com_prop_compos')
        table.integer('id_com_produtos').notNull().unsigned().references('id').inTable(migrationClientSchema + '.com_produtos').onUpdate('Cascade').onDelete('NO ACTION').comment('Chave estrangeira com a tabela com_produtos')

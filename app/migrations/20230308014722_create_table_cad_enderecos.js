exports.up = function(knex, Promise) {
    return knex.schema.createTable('vivazul_cso_jp.cad_enderecos', table => {
        table.engine('InnoDB')
        ...
        table.integer('id_cadastros').unsigned()
...
exports.down = function(knex, Promise) {
    return knex.schema.dropTable('vivazul_cso_jp.cad_enderecos')
};
exports.up = function(knex, Promise) {
    return knex.schema.createTable('vivazul_cliente_dominio.empresa', table => {
        table.engine('InnoDB')
        ...
        table.string('dominio',255).notNull().unique().comment('Domínio do cliente')
        ...
        table.string('emailAt',255).comment('Email da At')
        table.string('emailComercial',255).comment('Email comercial')
        table.string('emailFinanceiro',255).comment('Email do financeiro')
        table.string('emailRH',255).comment('Email do RH')
...
exports.down = function(knex, Promise) {
    return knex.schema.dropTable('vivazul_cliente_dominio.empresa')
};
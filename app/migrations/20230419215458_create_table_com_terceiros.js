exports.up = function(knex, Promise) {
    return knex.schema.createTable('vivazul_cliente_dominio.com_terceiros', table => {
        table.engine('InnoDB')
        ...
        table.integer('id_pipeline',11).unsigned().notNull().comment('Documento relacionado ')
        table.integer('id_com_agentes',11).unsigned().notNull().comment('Agente')
...
exports.down = function(knex, Promise) {
    return knex.schema.dropTable('vivazul_cliente_dominio.com_terceiros')
};
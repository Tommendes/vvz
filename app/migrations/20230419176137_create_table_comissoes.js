exports.up = function (knex, Promise) {
    return knex.schema.createTable('vivazul_bceaa5.com_terceiros', table => {
        table.engine('InnoDB')
        ...
        table.string('inss').comment('Informar o Número do registro social')
        ...
        table.string('liquidacao').comment('Data da liquidação')
...
exports.down = function (knex, Promise) {
    return knex.schema.dropTable('vivazul_bceaa5.com_terceiros')
};
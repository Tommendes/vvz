...
exports.up = function (knex, Promise) {
    return knex.schema.createTable(migrationClientSchema + '.comis_status', table => {
        table.engine('InnoDB')
        ...
        table.integer('id_comissoes', 10).unsigned().comment('Documento pai').references('id').inTable(migrationClientSchema + '.comissoes').onUpdate('Cascade').onDelete('Cascade')

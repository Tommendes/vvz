...
CREATE TABLE `empresa` (
  ...
  `email_at` varchar(255) DEFAULT NULL COMMENT 'Email da At',
  `email_comercial` varchar(255) DEFAULT NULL COMMENT 'Email comercial',
  `email_financeiro` varchar(255) DEFAULT NULL COMMENT 'Email do financeiro',
  `email_rh` varchar(255) DEFAULT NULL COMMENT 'Email do RH',
...
CREATE TABLE `pipeline` (
  ...
  CONSTRAINT `vivazul_cliente_dominio_pipeline_id_pipeline_params_foreign` FOREIGN KEY (`id_pipeline_params`) REFERENCES `pipeline_params` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `protocolo` (
  ...
  PRIMARY KEY (`id`),
  KEY `vivazul_cliente_dominio_protocolo_id_cadastros_foreign` (`id_cadastros`),
  CONSTRAINT `vivazul_cliente_dominio_protocolo_id_cadastros_foreign` FOREIGN KEY (`id_cadastros`) REFERENCES `cadastros` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pv_oat` (
  ...
  CONSTRAINT `vivazul_cliente_dominio_pv_oat_id_cadastro_endereco_foreign` FOREIGN KEY (`id_cadastro_endereco`) REFERENCES `pipeline_params` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,

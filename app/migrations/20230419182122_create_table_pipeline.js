exports.up = function(knex, Promise) {
    return knex.schema.createTable('vivazul_cso_root.pipeline', table => {
        table.engine('InnoDB')
        ...
        table.string('documento',255).defaultTo(0).comment('Data da liquidação')
        table.integer('versao',2).defaultTo(0).comment('Versão')
...
exports.down = function(knex, Promise) {
    return knex.schema.dropTable('vivazul_cso_root.pipeline')
};
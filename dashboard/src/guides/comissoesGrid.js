...
export const guide = `
    ...
    <ul>
        ...
        <li><strong>Coluna "Liquidação em":</strong> Indica a data de liquidação.</li>
        <li><strong>Coluna "Situação":</strong> Exibe o status da comissão (Lançado, Liquidado ou Encerrado.).</li>
        </ul>

...
export const guide = `
    ...
    <ul>
        ...
        <li><strong>Coluna "Tipo":</strong> Indica o tipo de comissão (Agente ou Representante).</li>
        <li><strong>Coluna "Agente":</strong> Mostra o nome do agente ou representante.</li>
        <li><strong>Coluna "Valor":</strong> Apresenta o valor da comissão.</li>
    ...
    <p>Para editar uma comissão, clique no ícone representado por três barras na coluna "Ações".</p>

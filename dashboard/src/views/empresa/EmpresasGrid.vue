...
const initFilters = () => {
    filters.value = {
        razaosocial: { value: '', matchMode: 'contains' },
        fantasia: { value: '', matchMode: 'contains' },
        cpf_cnpj_empresa: { value: '', matchMode: 'contains' },
        ie: { value: '', matchMode: 'contains' },
        ie_st: { value: '', matchMode: 'contains' },
        im: { value: '', matchMode: 'contains' },
        cnae: { value: '', matchMode: 'contains' },
        cep: { value: '', matchMode: 'contains' },
        logradouro: { value: '', matchMode: 'contains' },
        nr: { value: '', matchMode: 'contains' },
        complnr: { value: '', matchMode: 'contains' },
        bairro: { value: '', matchMode: 'contains' },
        cidade: { value: '', matchMode: 'contains' },
        uf: { value: '', matchMode: 'contains' }
    };
};
const filters = ref({});

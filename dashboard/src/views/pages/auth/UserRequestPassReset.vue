                ...
                <div class="w-full surface-card py-5 px-5" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="passRequest" class="">
                        ...
                        <div class="flex align-items-center justify-content-between mb-2">
                            <Button link style="color: var(--primary-color)" class="font-medium no-underline ml-2 text-center cursor-pointer" @click="router.push('/signup')"> Inscrever-se </Button>
                        ...
                        <Button rounded label="Recuperar" icon="pi pi-sign-in" :loading="click" :disabled="!cpf" type="submit" class="w-full p-3 text-xl"></Button>
                    </form>
                </div>
            </div>
        </div>

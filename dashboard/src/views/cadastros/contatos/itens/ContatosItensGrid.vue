...
<template>
    ...
    <ContatoItemForm v-if="mode == 'newItem'" @cancel="cancelNewItem()" @reload="loadData" :itemDataRoot="itemData" />
    <ContatoItemForm v-for="item in gridData" :key="item.id" :itemDataRoot="item" @reload="loadData" />

    ...
    <div class="card">
        ...
        >
            ...
            <Column headerStyle="width: 5rem; text-align: center" bodyStyle="text-align: center; overflow: visible">
                <template #body="{ data }">
                    <Button type="button" icon="fa-solid fa-bars" rounded @click="router.push({ path: `/${uProf.schema_description}/empresas/${data.id}` })" aria-haspopup="true" aria-controls="overlay_menu" class="p-button-outlined" />
                </template>
            </Column>
        </DataTable>
    </div>

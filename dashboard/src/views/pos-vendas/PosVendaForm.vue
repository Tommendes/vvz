...
<template>
    <Breadcrumb v-if="mode != 'new'" :items="[{ label: 'Pós-venda', to: `/${userData.cliente}/${userData.dominio}/pos-vendas` }, { label: itemData.id_cadastros + (store.userStore.admin >= 1 ? `: (${itemData.id})` : '') }]" />
    <div class="card">

...
const listaNomes = ref([
    ...
    { field: 'id_cadastro_endereco', label: 'Cadastro Endereço', minWidth: '30rem' },
    { field: 'id_tecnico', label: 'Técnico', minWidth: '30rem' },
    { field: 'nr_oat', label: 'Número OAT', minWidth: '30rem' }
]);

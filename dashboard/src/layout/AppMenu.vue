...
const setMenuByUser = async () => {
    ...
    if (uProf.value.comercial >= 1 || uProf.value.pipeline >= 1 || uProf.value.protocolos >= 1) {
        ...
        if (uProf.value.comercial >= 1 || uProf.value.pipeline >= 1) itemMenu.items.push({ label: 'Parâmetros do Pipeline', icon: 'fa-solid fa-cog', to: `/${uProf.value.schema_description}/pipeline-params` });
    ...
    if (uProf.value.pv >= 1 || uProf.value.at >= 1) {
        ...
        if (uProf.value.pv >= 1) itemMenu.items.push({ label: 'Pós-vendas', icon: 'fa-solid fa-briefcase', to: `/${uProf.value.schema_description}/pos-vendas` });
